...
public class Juego extends JFrame implements ActionListener{
	...
	public Juego() {
		...
		//Tablero del juego//
		System.out.println("De que tama�o desea que sea el juego:");
		int tama�o= Integer.parseInt(input.next());
		InterfazTablero interfazTablero=new InterfazTablero(tama�o);
        ...
        JLabel tama�oJLabel = new JLabel("Tama�o:");
        superior.add(tama�oJLabel);
        String[] optionsTama�o = {"3x3", "5x5"};
        JComboBox<String> jComboBox = new JComboBox<>(optionsTama�o);
